...
* Установка
  * [В Ubuntu](#В-ubuntu)
  * [В Fedora](#В-fedora)
  * [В Windows](#В-windows (на примере MiKTeX))
...
### В Windows (на примере MiKTeX)

>Протестировано в Windows 7.

В зависимости от битности операционной системы устанавливаете MiKTex 2.9 [MiKTeX 2.9 Setup](http://miktex.org/2.9/setup), после устанавливаете редактор LaTeX документов. Дождаться окончания установки MiKTeX желательно, тогда не придется вручную прописывать пути к файлам. Был протестирован [Texmaker](http://www.xm1math.net/texmaker/download.html).
